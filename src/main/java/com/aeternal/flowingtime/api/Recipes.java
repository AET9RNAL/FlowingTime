...
import com.aeternal.flowingtime.recipe.CraftingManager;
import com.aeternal.flowingtime.recipe.IInputHandler;
import com.aeternal.flowingtime.recipe.InputHandler;
...
public class Recipes {
    ...
    public static String registerRecipe(Recipe<?> Recipe) {
        String id = "flowingtime:" + "flowingtime_" + recipeID++;
