package com.aeternal.flowingtime.gameObjs.blocks;
...
public class Pedestal extends Block
{
    ...
    {
        super(Material.IRON);
        this.setCreativeTab(FlowingTimeCreativeTab.INSTANCE);
        this.setHardness(1.0F);
        this.setRegistryName("flpedestal");
    }
    ...
    private void dropItem(World world, BlockPos pos)
    {
        ...
        {
            FLPedestalTile tile = (FLPedestalTile) te;
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighbor, BlockPos neighborPos)
    {
        ...
        if (te instanceof FLPedestalTile)
        {
            FLPedestalTile ped = ((FLPedestalTile) te);
    ...
    {
        tooltip.add(I18n.format("fl.pedestal.tooltip1"));
        tooltip.add(I18n.format("fl.pedestal.tooltip2"));
    }
